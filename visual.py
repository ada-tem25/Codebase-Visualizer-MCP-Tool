...
if __name__ == "__main__":
    mcp.run(transport='stdio') #'stdio' is for local development, when the server is locally hosted. In production, for web-based development for exemple, we should use 'streamable-http'